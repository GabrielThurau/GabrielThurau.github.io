...
function addStyle(styleString) {
  ...
  div.Upsell_upsell-component__Ift65 > div > div > div:nth-child(1) {
  order: 2;
  }

 div.Upsell_upsell-component__Ift65 > div > div > div:nth-child(2) {
 order: 3;
 }
  ...
  console.log('variation 3 running');
  ...
  function doSwap(e) {
      ...
      document.querySelector("div.Upsell_upsell-component__Ift65 > div > div > div:nth-child(2)").style.display = "none";
       setTimeout(() => {
document.querySelector("div.Upsell_upsell-component__Ift65 > div > div > div:nth-child(3)").style.order = '2';
}, 1000);
